package com.jiay.distributeclock.distributetransactionconfig;
...
@MapperScan(basePackages = "com.jiay.distributeclock.mapper.test2",sqlSessionTemplateRef = "sqlSessionTemplate2")
